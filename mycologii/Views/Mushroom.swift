...
struct Mushroom: Hashable, Identifiable {
    let id = UUID()
    let name: String
    let image: String
    let url: String
...
struct MockData {
    ...
    static let sampleFramework = Mushroom(name: "Psilocybe",
                                           image: "arkit",
